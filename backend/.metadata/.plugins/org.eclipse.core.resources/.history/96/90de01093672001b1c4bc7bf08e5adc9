...
import com.nl.fos.security.JWT.JwtProvider;
...
public class UserController {
    ...
    public ResponseEntity<JwtResponse> login(@RequestBody LoginForm loginForm) {
        ...
        try {
            ...
            User user = userService.findOne(userDetails.getEmail());
            return ResponseEntity.ok(new JwtResponse(jwt, user.getEmail(), user.getUsername(), user.getRole().getName().name()));
    ...
    public ResponseEntity<?> save(@RequestBody SignUpRequest user) {
        try {
